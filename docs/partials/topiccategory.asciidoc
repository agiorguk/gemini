...
|Definition |Main theme(s) of the resource

|Purpose and meaning |The purpose of this element is to provide a basic
classification for the resource for use in initial searches

|Obligation |Mandatory when the resource is a dataset or dataset
...
|Guidance a|
. Select one or more categories that most closely represent the topic of the resource.
