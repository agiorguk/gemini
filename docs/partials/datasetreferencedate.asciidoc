...
|Definition |Reference date for the resource

|Purpose and meaning |Dataset reference date is an identifying date for
the resource. It is a notional date of 'publication' of the data
...
!===
! !Date !Date Type
!Definition !date used to reference resource !event used to
...
may be extended to include time (HH:MM:SS.ss, where HH is the hour, MM the
minute, SS the second, and ss is one or more digits representing a fraction of a second), with 'T' separating the two parts.
. Timezones may be appended, in any form defined in BS ISO 8601, such as Z to designate UTC or a +/- offset like +01:00.
...
the version. Thus if the resource is updated annually, only a year
...
|Examples a|
* 2001, precise to the calendar year
* 2005-05, precise to the calendar month
* 1997-10-01, precide to the calendar date
* 2009-05-02T09:10:01, precise to the time in minutes
* 2022-10-27T13:00:15.25, precise to the time in fractions of a second
* 2022-10-27T13:00Z, precise to the time in minutes, in UTC
* 2022-10-27T14:00+02:00, precise to the time in minutes 2 hours ahead of UTC
