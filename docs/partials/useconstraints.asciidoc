...
|Definition |Restrictions and legal restraints on using the resource

|Purpose and meaning |The purpose of this element is to describe any
restrictions on usage of the resource (as opposed to access)
...
access which describe limitations on access to the data. A resource
...
* GEMINI 2.3 December 2025: "data resource" to "resource"
====
...
. The MD_LegalConstraints element shall also contain a gmd:otherConstraints
