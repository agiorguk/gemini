...
|Definition |Topic of the content of the resource

|Purpose and meaning |The purpose of this element is to indicate the
general subject area of the resource using keywords. This enables
...
Keyword allows more appropriate terms to describe the resource.
...
!===
! !Keyword value !Keyword type !Originating controlled vocabulary
!Definition !topic of the content of the resource !identifies and groups keywords with a particular purpose !name of the
formally registered thesaurus or a similar authoritative source of keywords

!Obligation !mandatory !optional !conditional - required if keywords originate from a controlled vocabulary

!Occurrence !multiple !single !single

!Data type !CharacterString !Code list !Class CI_Citation (from ISO19115)

!Domain !free text !ISO/TC 211 Keyword type code!

!Other Comments !- !Available at  https://def.isotc211.org/common/KeywordTypeCode !a default value will generally be assigned for this
!===
...
be stated.
. Terms covering the subject of the resource should be selected.
...
. Keyword type is used to identify the purpose of the keyword and group keywords with a similar purpose
. Keyword type takes a value from https://def.isotc211.org/common/KeywordTypeCode

|Comment |This element is similar to Topic Category, but allows a
broader range of values. Avoid keywords of type 'place'; use #15 Extent instead
...
. GEMINI 2.3 December 2025: "data resource" -> "resource"
. GEMINI 2.3 March 2026: add sub element Keyword type
====
...
. Keyword type is only populated in Example 2
// end::dataset[]
// tag::service[]
