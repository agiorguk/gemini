...
|Definition |Vertical domain of the resource

|Purpose and meaning |The purpose of this element is to describe the
vertical range of the resource (where relevant).
...
!Definition !lowest vertical extent contained in the resource
!highest vertical extent contained in the resource !vertical
