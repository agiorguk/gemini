...
|Definition |Rectangle enclosing the extent of the resource
...
!Definition !western-most limit of the resource extent, expressed
...
(positive east) !southern-most limit of the resource extent,
expressed in latitude in decimal degrees (positive north) !northern-most
limit of the resource extent, expressed in latitude in decimal
...
|Guidance a|
. Identify a bounding box slightly larger than the extent of the resource, and determine the coordinates of the boundaries. It may be
