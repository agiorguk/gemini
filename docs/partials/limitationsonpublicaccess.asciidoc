...
|Definition |Restrictions imposed on accessing the resource for
...
. If there is no applicable limitation listed in Article 13, then the closest limitation shall be chosen, and 
a second limitations on public access element should be used to provide further information.
