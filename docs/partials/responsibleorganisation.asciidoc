...
|Purpose and meaning |This informs the user about who is responsible for the resource
...
should be identified for someone in a position of responsibility for the resource. +
...
. ISO 19115:2003 does not allow an organisation to have more than one role. Where in fact an organisation does carry out more than one role, and you need to express this in the GEMINI record, you will need to create more than one Responsible organisation (ISO 19115 point of contact)
...
[%collapsible]
====
* GEMINI 1 to 2.0: generalised from Distributor (and
...
corrected.
* July 2025: role occurrence set to 'single'; multiple was never supported in ISO 19115 anyway
* December 2025: "data resource" -> "resource"
====
