...
|Definition |Other descriptive information about the resource
...
'Additional information'
* GEMINI 2.3 June 2021 fixed typo (XML syntax error) in example 2; December 2025 "data resource" -> resource
====
