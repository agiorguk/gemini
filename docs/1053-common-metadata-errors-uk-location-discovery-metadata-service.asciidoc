...
link:1053-common-metadata-errors-uk-location-discovery-metadata-service.html#Intro[1. Introduction]

link:1053-common-metadata-errors-uk-location-discovery-metadata-service.html#schema_errors[2. Schema errors]

link:1053-common-metadata-errors-uk-location-discovery-metadata-service.html#ISO_errors[3. ISO 19139 Schematron errors]

link:1053-common-metadata-errors-uk-location-discovery-metadata-service.html#proc_errors[4. Processing Errors]

link:1053-common-metadata-errors-uk-location-discovery-metadata-service.html#inspire_warnings[5. European INSPIRE Geoportal errors and warnings]

link:1053-common-metadata-errors-uk-location-discovery-metadata-service.html#soft_errors[6. "Soft" errors]

link:1053-common-metadata-errors-uk-location-discovery-metadata-service.html#winner[7. And the winner?]
...
been collected into https://data.gov.uk/[data.gov.uk]. Approximately
...
series of
guides link:1047-metadata-guidelines-for-geospatial-data-resources-part-3.html[[27]].

Readers requiring an introduction to discovery metadata for geospatial
resources are referred to the UK GEMINI guide “Metadata Guidelines
...
software companies are developing tools. To validate a metadata record
...
* Validate using the GEMINI 2.3 schematron (https://github.com/agiorguk/gemini-schematron)
...
A second (supplemental) GEMINI schematron is provided to test for
...
With GEMINI 2.3, a second (supplemental) schematron is provided to test
for recommendations.
...
_{nbsp}Last updated: December 2025_
