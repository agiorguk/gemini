...
* link:1062-gemini-datasets-and-data-series.html#23[Responsible Organisation]: Updated guidance to indicate that the role should be a single occurrence, and to advise on use of individual names
* link:1062-gemini-datasets-and-data-series.html#36[Resource Identifier]: Improved guidance on designing resource identifiers, and stated strong preference for using MD_Identifier rather than RS_Identifier for the encoding
* link:1062-gemini-datasets-and-data-series.html#44[Bounding Box]: Updated guidance on the use of WGS84, the degree of precision, and how to encode more precise polygon extents.
* link:1048-uk-gemini-encoding-guidance.html[Encoding Guidance]: Fixed broken links
* link:1062-gemini-datasets-and-data-series.html#15[Extent]: Added example of an extent keyword such as OS linked data gazetteer, or ONS Output area
