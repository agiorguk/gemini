...
Note: see http://www.opengeospatial.org/standards/specifications/catalog
...
information about a resource, used to discover and
...
Note: one of a number of business services developed for the UK
Location Information Infrastructure. Now embedded within data.gov.uk
...
metadata instances where _XSD_ schemas are used to define the structure
of XML documents.
...
Note: in this document the term GEMINI2 means version 2.3 of UK GEMINI.
...
The committee responsible for standards such as ISO 19115, ISO 19136
and ISO 19139.
...
211 is https://committee.iso.org/home/tc211
...
collection of metadata about a set of resources

*metadata element*

individual item of metadata relating to a resource, e.g. Extent, Topic
...
_XML document_ conforming to ISO / TS 19139 and other associated standards.
...
identifiable set of metadata relating to a single resource
...
review of quality of a resource
