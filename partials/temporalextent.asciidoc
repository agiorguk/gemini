...
|Definition |Date for the content of the resource
...
|Comment a|
. If the resource relates to a historic period, then this is part
...
is an identifying date for the resource.
...
date for the resource. For example, an atlas might represent data
