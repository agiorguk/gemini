...
|Definition |Extent of resource

|Purpose and meaning |This element defines the geographical extent of
coverage of the resource relative to an administrative hierarchy.
...
external gazetteer. Note that Extent is the coverage of the resource, not the individual objects in the resource. Thus if the
resource was national parks in England, the Extent would be
...
|Guidance a|
. An area approximating to the extent of coverage of the resource
...
GEMINI 2.3 December 2025: "data resource" -> "resource" and removed non-working examples
====
